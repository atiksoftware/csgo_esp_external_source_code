...
public:
	...
	LPDIRECT3DTEXTURE9 weaponTex[100];
	LPD3DXSPRITE weaponSprite[100];
	boolean weaponTried[100];
	boolean weaponSuccess[100];
	...
	void WeaponLogo(float x, float y, int weaponId, LPDIRECT3DDEVICE9EX dev);
